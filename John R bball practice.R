...
list_opp <- list(
  `1992oppstats`,`1993oppstats`,`1994oppstats`,`1995oppstats`,`1996oppstats`,
  `1997oppstats`,`1998oppstats`,`1999oppstats`,`2000oppstats`,`2001oppstats`,
  `2002oppstats`,`2003oppstats`,`2004oppstats`,`2005oppstats`,`2006oppstats`,
  `2007oppstats`,`2008oppstats`,`2009oppstats`,`2010oppstats`,`2011oppstats`,
  `2012oppstats`,`2013oppstats`,`2014oppstats`,`2015oppstats`,`2016oppstats`)
...
change_opp <- lapply(list_opp, function(df) {
...
# nbateam
list_team <- list(
  `1992nbateamstats`,`1993nbateamstats`,`1994nbateamstats`,`1995nbateamstats`,
  `1996nbateamstats`,`1997nbateamstats`,`1998nbateamstats`,`1999nbateamstats`,
  `2000nbateamstats`,`2001nbateamstats`,`2002nbateamstats`,`2003nbateamstats`,
  `2004nbateamstats`,`2005nbateamstats`,`2006nbateamstats`,`2007nbateamstats`,
  `2008nbateamstats`,`2009nbateamstats`,`2010nbateamstats`,`2011nbateamstats`,
  `2012nbateamstats`,`2013nbateamstats`,`2014nbateamstats`,`2015nbateamstats`,
  `2016nbateamstats`)
change_team <- Map(cbind, list_team, year = years)
team_stats  <- do.call("rbind", change_team)

# misc stats
list_misc <- list(
  `1992miscstats`,`1993miscstats`,`1994miscstats`,`1995miscstats`,
  ...
  `2016miscstats`)
change_misc <- Map(cbind, list_misc, year = years)
...
all_stats$Team <- gsub("Bobcats", "Hornets",     all_stats$Team)
all_stats$Team <- gsub("Bullets", "Wizards",     all_stats$Team)
all_stats$Team <- gsub("New Jersey", "Brooklyn", all_stats$Team)
all_stats$Team <- gsub("Vancouver", "Memphis",   all_stats$Team)
all_stats$Team <- gsub("New Orleans Hornets", "New Orleans Pelicans", 
                       all_stats$Team)
all_stats$Team <- gsub("Seattle SuperSonics", "Oklahoma City Thunder", 
                       all_stats$Team)
all_stats$Team <- gsub("New Orleans/Oklahoma City Hornets", 
                       "New Orleans Pelicans", all_stats$Team)
...
#   "East" &
#   all_stats$Team(c(
#   "Golden State Warriors", "San Antonio Spurs", "Houston Rockets", 
...
index <- c(
  ...
  "New York Knicks", "Orlando Magic", "Philadelphia 76ers", "Brooklyn Nets",
  "Golden State Warriors", "San Antonio Spurs", "Houston Rockets",  
